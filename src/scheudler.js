...
// TODO: RE-Scheudling at midnight
...
module.exports = {
  ...
  update: function(){
    ...
    // TODO: only update jobs that have changed
    this.jobs=[];
  ...
  // scheudle an job (creates an callback and event) 
